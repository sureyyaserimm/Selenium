...
public class Senaryo2 extends BaseDriver {
    ...
    public void Test2(){
        ...
        WebElement message=driver.findElement(By.cssSelector("div[class='validation-summary-errors']>ul>li"));

        Assert.assertTrue(message.getText().equals("The specified email already exists"));
        BekleKapat();
    }
}
